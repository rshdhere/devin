...
import { isLikelyBlankScreenshot } from "@scheduler/task/service/desktop-snapshot-blank.js";
import { persistDesktopSnapshot } from "@scheduler/task/service/desktop-capture-fetch.js";
...
describe("shouldCapturePreviewOnPortChange", () => {
  it("skips capture while the agent task is processing", async () => {
    const { shouldCapturePreviewOnPortChange } =
      await import("@scheduler/task/service/desktop-capture-render.js");
    const svc = {
