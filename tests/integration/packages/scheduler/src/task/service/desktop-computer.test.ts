...
vi.mock("@scheduler/task/service/desktop-capture-render.js", () => ({
...
vi.mock("@scheduler/task/service/session-lifecycle.js", () => ({
...
import { ensureDesktopComputer } from "@scheduler/task/service/desktop-computer.js";
