...
import type { BuildSystemPromptInput } from "./types.js";

function productImplementationGuidance(stack?: BrainStackRuntime): string[] {
  const lines = [
...
export function buildSystemPrompt(input: BuildSystemPromptInput): string {
  ...
  if (input.requireProductImplementation) {
    lines.push(...productImplementationGuidance(stack));
  }
