...
If sandbox create fails with `clone golden rootfs` / `No space left on device`, see [docs/microvm-guardrails.md](../docs/microvm-guardrails.md) (host disk vs guest tmpfs, recovery steps).
...
| Guardrail env vars | See [docs/microvm-guardrails.md](../docs/microvm-guardrails.md) |
